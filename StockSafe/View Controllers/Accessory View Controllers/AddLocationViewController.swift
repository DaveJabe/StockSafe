...
class AddLocationViewController: UIViewController {
    ...
    @IBAction func addLocation(_ sender: UIButton) {
        let ldvc = presentingViewController?.children.first(where: { $0.restorationIdentifier == "locationDashboard" }) as? LocationsViewController
    ...
    override func viewDidLayoutSubviews() {
        ...
        addLocationButton.addShadow()
        addNewLocationLabel.addSubtleShadow()
    }
